    ...
    <footer className="bg-gradient-to-t from-gray-950 via-gray-900 to-gray-800 text-white py-10 mt-16 shadow-2xl border-t border-gray-700">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between gap-8">
        <div className="flex flex-col items-start gap-2">
          <span className="font-extrabold text-2xl tracking-tight text-accent">Web Portofolio</span>
          <span className="text-sm text-white/60">by Ahmad Riyo Kusuma</span>
        </div>
        ...
        <div className="flex flex-col items-end gap-2 text-right">
          ...
          <span className="text-xs text-white/40">Instagram: <a href="https://instagram.com/ahmd_riyo" target="_blank" className="hover:text-accent">@ahmd_riyo</a></span>
        </div>
      </div>
      <div className="text-center text-xs text-white/50 mt-8">&copy;{new Date().getFullYear()} Ahmad Riyo Kusuma. All rights reserved.</div>
    </footer>
  );
}
